	...
	namespace Cells {
		namespace System {
			...
			public:
				...
				static StringPtr NumberToString(StringPtr format, UInt32 value, intrusive_ptr<NumberFormatInfo> fp);
				static StringPtr NumberToString(StringPtr format, Int32 value, intrusive_ptr<NumberFormatInfo> fp);
				static StringPtr NumberToString(StringPtr format, UInt64 value, intrusive_ptr<NumberFormatInfo> fp);
				static StringPtr NumberToString(StringPtr format, Int64 value, intrusive_ptr<NumberFormatInfo> fp);
				static StringPtr NumberToString(StringPtr format, Double value, intrusive_ptr<NumberFormatInfo> fp);
				static StringPtr NumberToString(StringPtr format, Single value, intrusive_ptr<NumberFormatInfo> fp);
			...
			private:
				...
				StringPtr IntegerToString(StringPtr format, intrusive_ptr<NumberFormatInfo> fp);
