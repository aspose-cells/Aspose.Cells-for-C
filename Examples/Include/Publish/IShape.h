...
namespace Drawing{
			...
			/// </summary>
	class ASPOSE_CELLS_API IShape : public Aspose::Cells::System::Object
	{
		public:
			/// <summary>
			/// Gets the name of macro.
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::String> GetMacroName()=0;
			/// <summary>
			/// Sets the name of macro.
			/// </summary>
			 virtual void SetMacroName(intrusive_ptr<Aspose::Cells::System::String> value)=0;
			/// <summary>
			/// Returns the position of a shape in the z-order. 
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetZOrderPosition()=0;
			/// <summary>
			/// Returns the position of a shape in the z-order. 
			/// </summary>
			 virtual void SetZOrderPosition(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			...
			///  object.
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::String> GetAlternativeText()=0;
			/// <summary>
			/// Returns or sets the descriptive (alternative) text string of the <see cref="IShape" />
			///  object.
			/// </summary>
			 virtual void SetAlternativeText(intrusive_ptr<Aspose::Cells::System::String> value)=0;
			/// <summary>
			...
			/// </summary>
			 virtual Aspose::Cells::System::Double GetSoftEdges()=0;
			/// <summary>
			/// Sets the radius of blur to apply to the edges, in unit of points.
			/// </summary>
			 virtual void SetSoftEdges(Aspose::Cells::System::Double value)=0;
			/// <summary>
			...
			/// Gets the rotation of the shape.
			/// </summary>
			 virtual Aspose::Cells::System::Double GetRotationAngle()=0;
			/// <summary>
			/// Sets the rotation of the shape.
			/// </summary>
			 virtual void SetRotationAngle(Aspose::Cells::System::Double value)=0;
			/// <summary>
			/// Adds a hyperlink to the shape.
			/// </summary>
			/// <param name="address" >Address of the hyperlink.</param>
			/// <returns>Return the new hyperlink object.</returns>
			 virtual intrusive_ptr<Aspose::Cells::IHyperlink> 		AddIHyperlink(intrusive_ptr<Aspose::Cells::System::String> address)=0;
			/// <summary>
			...
			/// <param name="lowerRightColumn" >Lower right column index</param>
			 virtual void MoveToRange(Aspose::Cells::System::Int32 upperLeftRow , Aspose::Cells::System::Int32 upperLeftColumn , Aspose::Cells::System::Int32 lowerRightRow , Aspose::Cells::System::Int32 lowerRightColumn)=0;
			/// <summary>
			/// Moves the picture to the top-right corner.
			/// </summary>
			/// <param name="topRow" >the row index.</param>
			/// <param name="rightColumn" >the column index.</param>
			 virtual void AlignTopRightCorner(Aspose::Cells::System::Int32 topRow , Aspose::Cells::System::Int32 rightColumn)=0;
			/// <summary>
			/// Gets the identifier of this shape.
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetId()=0;
			/// <summary>
			/// Specifies an optional string that an application can use to Identify the particular shape. 
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::String> GetSpid()=0;
			/// <summary>
			/// Specifies an optional number that an application can use to associate the particular shape with a defined shape type.  
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetSpt()=0;
			/// <summary>
			...
			/// <remarks>If the shape is in the shape or in the group , UpperLeftRow will be ignored.</remarks>
			 virtual Aspose::Cells::System::Int32 GetUpperLeftRow()=0;
			/// <summary>
			/// Represents upper left corner row index. 
			/// </summary>
			/// <remarks>If the shape is in the shape or in the group , UpperLeftRow will be ignored.</remarks>
			 virtual void SetUpperLeftRow(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Gets the shape's vertical offset from its upper left corner row.
			/// <remarks>The range of value is 0 to 256.</remarks>
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetUpperDeltaY()=0;
			/// <summary>
			/// Sets the shape's vertical offset from its upper left corner row.
			/// <remarks>The range of value is 0 to 256.</remarks>
			/// </summary>
			 virtual void SetUpperDeltaY(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Represents upper left corner column index.
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetUpperLeftColumn()=0;
			/// <summary>
			/// Represents upper left corner column index.
			/// </summary>
			 virtual void SetUpperLeftColumn(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Gets the shape's horizontal offset from its upper left corner column.
			/// <remarks>The range of value is 0 to 1024.</remarks>
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetUpperDeltaX()=0;
			/// <summary>
			/// Sets the shape's horizontal offset from its upper left corner column.
			/// <remarks>The range of value is 0 to 1024.</remarks>
			/// </summary>
			 virtual void SetUpperDeltaX(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Represents lower right corner row index.
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetLowerRightRow()=0;
			/// <summary>
			/// Represents lower right corner row index.
			/// </summary>
			 virtual void SetLowerRightRow(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Gets the shape's vertical offset from its lower right corner row.
			/// <remarks>The range of value is 0 to 256.</remarks>
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetLowerDeltaY()=0;
			/// <summary>
			/// Sets the shape's vertical offset from its lower right corner row.
			/// <remarks>The range of value is 0 to 256.</remarks>
			/// </summary>
			 virtual void SetLowerDeltaY(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Represents lower right corner column index.
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetLowerRightColumn()=0;
			/// <summary>
			/// Represents lower right corner column index.
			/// </summary>
			 virtual void SetLowerRightColumn(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Gets the shape's horizontal  offset from its lower right corner column.
			/// <remarks>The range of value is 0 to 1024.</remarks>
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetLowerDeltaX()=0;
			/// <summary>
			/// Gets the shape's horizontal  offset from its lower right corner column.
			/// <remarks>The range of value is 0 to 1024.</remarks>
			/// </summary>
			 virtual void SetLowerDeltaX(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Represents the width of the shape's horizontal  offset from its lower right corner column, in unit of pixels.
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetRight()=0;
			/// <summary>
			/// Represents the width of the shape's horizontal  offset from its lower right corner column, in unit of pixels.
			/// </summary>
			 virtual void SetRight(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetBottom()=0;
			/// <summary>
			/// Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.
			/// </summary>
			 virtual void SetBottom(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			...
			/// </summary>
			 virtual Aspose::Cells::System::Double GetWidthPt()=0;
			/// <summary>
			///  Represents the width of the shape, in unit of point. 
			/// </summary>
			 virtual void SetWidthPt(Aspose::Cells::System::Double value)=0;
			/// <summary>
			...
			/// </summary>
			 virtual Aspose::Cells::System::Double GetHeightPt()=0;
			/// <summary>
			/// Represents the height of the shape, in unit of points. 
			/// </summary>
			 virtual void SetHeightPt(Aspose::Cells::System::Double value)=0;
			/// <summary>
			/// Represents the height of the shape, in unit of inches. 
			/// </summary>
			...
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetLeft()=0;
			/// <summary>
			/// Represents the horizontal offset of shape from its left column, in unit of pixels.
			/// </summary>
			 virtual void SetLeft(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Represents the horizontal offset of shape from its left column, in unit of inches.
			/// </summary>
			 virtual Aspose::Cells::System::Double GetLeftInch()=0;
			/// <summary>
			/// Represents the horizontal offset of shape from its left column, in unit of inches.
			/// </summary>
			 virtual void SetLeftInch(Aspose::Cells::System::Double value)=0;
			/// <summary>
			/// Represents the horizontal offset of shape from its left column, in unit of centimeters.
			/// </summary>
			 virtual Aspose::Cells::System::Double GetLeftCM()=0;
			/// <summary>
			/// Represents the horizontal offset of shape from its left column, in unit of centimeters.
			/// </summary>
			 virtual void SetLeftCM(Aspose::Cells::System::Double value)=0;
			/// <summary>
			/// Represents the vertical offset of shape from its top row, in unit of pixels.
			/// </summary>
			/// <remarks>If the shape is in the chart, represents the vertical offset of shape from its top border.</remarks>
			 virtual Aspose::Cells::System::Int32 GetTop()=0;
			/// <summary>
			/// Represents the vertical offset of shape from its top row, in unit of pixels.
			/// </summary>
			/// <remarks>If the shape is in the chart, represents the vertical offset of shape from its top border.</remarks>
			 virtual void SetTop(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			///  Represents the vertical offset of shape from its top row, in unit of inches.
			/// </summary>
			 virtual Aspose::Cells::System::Double GetTopInch()=0;
			/// <summary>
			///  Represents the vertical offset of shape from its top row, in unit of inches.
			/// </summary>
			 virtual void SetTopInch(Aspose::Cells::System::Double value)=0;
			/// <summary>
			///  Represents the vertical offset of shape from its top row, in unit of centimeters.
			/// </summary>
			 virtual Aspose::Cells::System::Double GetTopCM()=0;
			/// <summary>
			///  Represents the vertical offset of shape from its top row, in unit of centimeters.
			/// </summary>
			 virtual void SetTopCM(Aspose::Cells::System::Double value)=0;
			/// <summary>
			/// Gets and sets the vertical offset of shape from worksheet top boder,in unit of pixel
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetTopToCorner()=0;
			/// <summary>
			/// Gets and sets the vertical offset of shape from worksheet top boder,in unit of pixel
			/// </summary>
			 virtual void SetTopToCorner(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Gets the horizonal offset of shape from worksheet left border.
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetLeftToCorner()=0;
			/// <summary>
			/// Sets the horizonal offset of shape from worksheet left border.
			/// </summary>
			 virtual void SetLeftToCorner(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			...
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetWidthScale()=0;
			/// <summary>
			/// Sets the width scale, in unit of percent of the original picture width.
			/// If the shape is not picture ,the WidthScale property only returns 100;
			/// </summary>
			 virtual void SetWidthScale(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			...
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetHeightScale()=0;
			/// <summary>
			/// Sets the height scale,in unit of percent of the original picture height.
			/// If the shape is not picture ,the HeightScale property only returns 100;
			/// </summary>
			 virtual void SetHeightScale(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			...
			/// <remarks>Only Applies when this shape in the group or chart.</remarks>
			 virtual Aspose::Cells::System::Int32 GetTopInShape()=0;
			/// <summary>
			/// Represents the vertical offset of shape from the top border of the parent shape, 
			/// in unit of 1/4000 of height of the parent shape.
			/// </summary>
			/// <remarks>Only Applies when this shape in the group or chart.</remarks>
			 virtual void SetTopInShape(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			...
			/// </summary>
			/// <remarks>Only Applies when this shape in the group or chart.</remarks>
			 virtual Aspose::Cells::System::Int32 GetLeftInShape()=0;
			/// <summary>
			/// Represents the horizontal offset of shape from the left border of the parent shape, 
			/// in unit of 1/4000 of width of the parent shape.
			/// </summary>
			/// <remarks>Only Applies when this shape in the group or chart.</remarks>
			 virtual void SetLeftInShape(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Represents the width of the shape, in unit of 1/4000 of the parent shape.
			/// </summary>
			/// <remarks>Only Applies when this shape in the group or chart.</remarks>
			 virtual Aspose::Cells::System::Int32 GetWidthInShape()=0;
			/// <summary>
			/// Represents the width of the shape, in unit of 1/4000 of the parent shape.
			/// </summary>
			/// <remarks>Only Applies when this shape in the group or chart.</remarks>
			 virtual void SetWidthInShape(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			/// Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape..
			/// </summary>
			/// <remarks>Only Applies when this shape in the group or chart.</remarks>
			 virtual Aspose::Cells::System::Int32 GetHeightInShape()=0;
			/// <summary>
			/// Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape..
			/// </summary>
			/// <remarks>Only Applies when this shape in the group or chart.</remarks>
			 virtual void SetHeightInShape(Aspose::Cells::System::Int32 value)=0;
			/// <summary>
			...
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::String> GetInputRange()=0;
			/// <summary>
			/// Sets the worksheet range used to fill the specified combo box. 
			/// </summary>
			 virtual void SetInputRange(intrusive_ptr<Aspose::Cells::System::String> value)=0;
			/// <summary>
			...
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::String> GetHtmlText()=0;
			/// <summary>
			/// Sets the html string which contains data and some formats in this textbox.
			/// </summary>
			 virtual void SetHtmlText(intrusive_ptr<Aspose::Cells::System::String> value)=0;
			/// <summary>
			...
			/// <param name="length" >The the length.</param>
			/// <param name="font" >The font setting.</param>
			 virtual void 		FormatCharactersByIFont(Aspose::Cells::System::Int32 startIndex , Aspose::Cells::System::Int32 length , intrusive_ptr<Aspose::Cells::IFont> font)=0;
			/// <summary>
			...
			/// </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::Array1D<Aspose::Cells::System::Byte>> GetControlData()=0;
			/// <summary>
			/// Get the actual bottom row.
			/// </summary>
			 virtual Aspose::Cells::System::Int32 GetActualLowerRightRow()=0;
			/// <summary>
			/// Recalculate the text area
			/// </summary>
			/// <returns>Text's Size in an array(width and height).</returns>
			 virtual intrusive_ptr<Aspose::Cells::System::Array1D<Aspose::Cells::System::Int32>> CalculateTextSize()=0;
