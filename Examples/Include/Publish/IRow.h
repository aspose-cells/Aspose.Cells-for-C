...
namespace Cells{
	...
	class ASPOSE_CELLS_API IRow : public Aspose::Cells::System::Collections::IEnumerable , public Aspose::Cells::System::Object
	{
		public:
			...
			/// 
			/// <returns>The ICell object.</returns>
			/// 
			/// <remarks>NOTE: This member is now obsolete. 
			/// Instead, please use GetEnumerator() method to iterate all cells in this row.</remarks>
			/// 
			/// 
			...
			/// 
			/// 
			 virtual void SetIsHeightMatched(bool value)=0;
			/// <summary>
			/// Represents the style of this row.
			/// </summary>
			/// 
			/// <remarks> You have to call IRow.ApplyStyle() method to save your changing with the row style,
