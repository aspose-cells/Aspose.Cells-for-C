...
namespace Charts{
			...
			///  objects.
			/// </summary>
	class ASPOSE_CELLS_API ISeriesCollection : public Aspose::Cells::System::Collections::CollectionBase
	{
		public:
			/// <summary>
			...
			/// <returns>The element at the specified index.</returns>
			 virtual intrusive_ptr<Aspose::Cells::Charts::ISeries> 		GetObjectByIndex(Aspose::Cells::System::Int32 index)=0;
			/// <summary>
			/// Gets the <see cref="ISeries" />
			///  element by order.
			/// </summary>
			...
			/// <returns>The element series</returns>
			 virtual intrusive_ptr<Aspose::Cells::Charts::ISeries> 		GetISeriesByOrder(Aspose::Cells::System::Int32 order)=0;
			/// <summary>
			...
			///  </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::String> GetCategoryData()=0;
			/// <summary>
			/// Sets the range of category Axis values. 
			///  It can be a range of cells (such as, "d1:e10"), 
			///  or a sequence of values (such as,"{2,6,8,10}"). 
			///  </summary>
			 virtual void SetCategoryData(intrusive_ptr<Aspose::Cells::System::String> value)=0;
			/// <summary>
			...
			///  </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::String> GetSecondCatergoryData()=0;
			/// <summary>
			...
			///  Only effects when some ASerieses plot on the second axis.
			///  </summary>
			 virtual void SetSecondCatergoryData(intrusive_ptr<Aspose::Cells::System::String> value)=0;
			/// <summary>
			/// Gets the range of second category Axis values. 
			///  It can be a range of cells (such as, "d1:e10"), 
			///  or a sequence of values (such as,"{2,6,8,10}"). 
			///  Only effects when some ASerieses plot on the second axis.
			///  </summary>
			 virtual intrusive_ptr<Aspose::Cells::System::String> GetSecondCategoryData()=0;
			/// <summary>
			/// Sets the range of second category Axis values. 
			///  It can be a range of cells (such as, "d1:e10"), 
			///  or a sequence of values (such as,"{2,6,8,10}"). 
			///  Only effects when some ASerieses plot on the second axis.
			///  </summary>
			 virtual void SetSecondCategoryData(intrusive_ptr<Aspose::Cells::System::String> value)=0;
			/// <summary>
			...
			/// <param name="destIndex" >The dest index</param>
			 virtual void ChangeSeriesOrder(Aspose::Cells::System::Int32 sourceIndex , Aspose::Cells::System::Int32 destIndex)=0;
			/// <summary>
			...
			/// </remarks>
			 virtual Aspose::Cells::System::Int32 AddR1C1(intrusive_ptr<Aspose::Cells::System::String> area , bool isVertical)=0;
			/// <summary>
			/// Adds the <see cref="ISeriesCollection" />
			///  collection to a chart.
			/// </summary>
			...
			/// </remarks>
			 virtual Aspose::Cells::System::Int32 Add(intrusive_ptr<Aspose::Cells::System::String> area , bool isVertical)=0;
			/// <summary>
