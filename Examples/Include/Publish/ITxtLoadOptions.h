...
namespace Cells{
	...
	class ASPOSE_CELLS_API ITxtLoadOptions : virtual public Aspose::Cells::ILoadOptions
	{
		public:
			...
			/// True means that the file contains several encoding.
			/// </summary>
			 virtual void SetIsMultiEncoded(bool value)=0;
			/// <summary>
			...
			/// please set LoadStyleStrategy value to TxtLoadStyleStrategy_BuiltIn to get same result with this property's false value
			/// and TxtLoadStyleStrategy_ExactFormat to get same result with this property's true value.
			/// </remarks>
