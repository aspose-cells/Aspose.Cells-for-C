...
namespace Cells{
			...
			/// </code>
			/// </example>
	class ASPOSE_CELLS_API IHorizontalPageBreakCollection : public Aspose::Cells::System::Collections::CollectionBase
	{
		public:
			/// <summary>
			...
			/// <returns>The element at the specified index.</returns>
			 virtual intrusive_ptr<Aspose::Cells::IHorizontalPageBreak> 		GetObjectByIndex(Aspose::Cells::System::Int32 index)=0;
			/// <summary>
			/// Gets the <see cref="IHorizontalPageBreak" />
			...
			/// <returns>The element with the specified cell name.</returns>
			 virtual intrusive_ptr<Aspose::Cells::IHorizontalPageBreak> 		GetObjectByIndex(intrusive_ptr<Aspose::Cells::System::String> cellName)=0;
			/// <summary>
			...
			/// <remarks>This method is used to add a horizontal page break within a print area.</remarks>
			 virtual Aspose::Cells::System::Int32 Add(Aspose::Cells::System::Int32 row , Aspose::Cells::System::Int32 startColumn , Aspose::Cells::System::Int32 endColumn)=0;
			/// <summary>
			/// Adds a horizontal page break to the collection.
			/// </summary>
			...
			/// Please set a horizontal page break and a vertical page break concurrently.</remarks>
			 virtual Aspose::Cells::System::Int32 Add(Aspose::Cells::System::Int32 row)=0;
			/// <summary>
			/// Adds a horizontal page break to the collection.
			/// </summary>
			/// <param name="row" >Cell row index, zero based.</param>
