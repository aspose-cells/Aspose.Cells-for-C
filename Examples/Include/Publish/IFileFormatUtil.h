...
public:
			...
			/// 
			/// 
			static  intrusive_ptr<Aspose::Cells::IFileFormatInfo> 		DetectFileFormat_i(intrusive_ptr<Aspose::Cells::System::IO::Stream> stream);
			/// <summary>
			...
			/// 
			/// 
			static  intrusive_ptr<Aspose::Cells::IFileFormatInfo> 		DetectFileFormat_i(intrusive_ptr<Aspose::Cells::System::String> filePath);
			/// <summary>
			...
			/// 
			/// 
			static  Aspose::Cells::SaveFormat 		ExtensionToSaveFormat_i(intrusive_ptr<Aspose::Cells::System::String> extension);
			/// <summary>
			...
			/// 
			/// 
			static  bool 		IsTemplateFormat_i(intrusive_ptr<Aspose::Cells::System::String> extension);
			/// <summary>
			...
			/// 
			/// <remarks>If cannot convert, returns null.</remarks>
			/// 
			/// 
			static  intrusive_ptr<Aspose::Cells::System::String> 		LoadFormatToExtension_i(Aspose::Cells::LoadFormat loadFormat);
			/// <summary>
			...
			/// 
			/// 
			static  Aspose::Cells::SaveFormat 		LoadFormatToSaveFormat_i(Aspose::Cells::LoadFormat loadFormat);
			/// <summary>
			...
			/// 
			/// 
			static  intrusive_ptr<Aspose::Cells::System::String> 		SaveFormatToExtension_i(Aspose::Cells::SaveFormat format);
			/// <summary>
			...
			/// 
			/// 
			static  Aspose::Cells::LoadFormat 		SaveFormatToLoadFormat_i(Aspose::Cells::SaveFormat saveFormat);
