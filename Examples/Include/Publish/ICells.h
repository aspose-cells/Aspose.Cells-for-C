...
namespace Cells{
	...
	class ASPOSE_CELLS_API ICells : public Aspose::Cells::System::Collections::IEnumerable , public Aspose::Cells::System::Object
	{
		public:
			...
			/// </summary>
			/// 
			/// <remarks>In this collection, each item is an <see cref="ICellArea" />
			...
			/// 
			/// 
			 virtual void SetStyle(intrusive_ptr<Aspose::Cells::IStyle> value)=0;
			/// <summary>
			...
			/// please use GetLastDataRow(int) method of ICells. 
			/// This method will be removed 12 months later since June 2010. 
			/// Aspose apologizes for any inconvenience you may have experienced.</remarks>
			/// 
			/// 
			 virtual Aspose::Cells::System::Int32 MaxDataRowInColumn(Aspose::Cells::System::Int32 column)=0;
			/// <summary>
			...
			/// <remarks>Returns null (Nothing) if no cell is found.
			/// NOTE: This member is now obsolete. Instead, 
			/// please use Find() method of ICells
			/// This member will be removed 12 months later since May 2012. 
			/// Aspose apologizes for any inconvenience you may have experienced.</remarks>
			/// 
			/// 
