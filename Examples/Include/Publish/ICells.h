	...
	class ASPOSE_CELLS_API ICells : public Aspose::Cells::System::Collections::IEnumerable , public Aspose::Cells::System::Object
	{
		public:
			...
			/// <param name="options" >The split options.</param>
			 virtual void 		TextToColumns(Aspose::Cells::System::Int32 row , Aspose::Cells::System::Int32 column , Aspose::Cells::System::Int32 totalRows , intrusive_ptr<Aspose::Cells::ITxtLoadOptions> options)=0;
			/// <summary>
			...
			/// <param name="flag" >Flags which indicates applied formatting properties.</param>
			 virtual void 		ApplyColumnIStyle(Aspose::Cells::System::Int32 column , intrusive_ptr<Aspose::Cells::IStyle> style , intrusive_ptr<Aspose::Cells::IStyleFlag> flag)=0;
			/// <summary>
			...
			/// <param name="Istyle" >The style object which will be applied.</param>
			/// <param name="flag" >Flags which indicates applied formatting properties.</param>
			 virtual void 		ApplyRowIStyle(Aspose::Cells::System::Int32 row , intrusive_ptr<Aspose::Cells::IStyle> style , intrusive_ptr<Aspose::Cells::IStyleFlag> flag)=0;
			/// <summary>
			...
			/// <param name="destinationColumnIndex" >Destination column index.</param>
			 virtual void 		CopyIColumn(intrusive_ptr<Aspose::Cells::ICells> sourceCells , Aspose::Cells::System::Int32 sourceColumnIndex , Aspose::Cells::System::Int32 destinationColumnIndex)=0;
			/// <summary>
			/// Copies data and formatting of a whole column.
			/// </summary>
			/// <param name="sourceCells" >Source Cells object contains data and formatting to copy.</param>
			...
			/// <param name="columnNumber" >The copied column number.</param>
			 virtual void 		CopyIColumns(intrusive_ptr<Aspose::Cells::ICells> sourceCells , Aspose::Cells::System::Int32 sourceColumnIndex , Aspose::Cells::System::Int32 destinationColumnIndex , Aspose::Cells::System::Int32 columnNumber)=0;
			/// <summary>
			...
			/// <param name="destinationTotalColumns" >The number of the destination columns.</param>
			 virtual void 		CopyIColumns(intrusive_ptr<Aspose::Cells::ICells> sourceCells , Aspose::Cells::System::Int32 sourceColumnIndex , Aspose::Cells::System::Int32 sourceTotalColumns , Aspose::Cells::System::Int32 destinationColumnIndex , Aspose::Cells::System::Int32 destinationTotalColumns)=0;
			/// <summary>
			...
			/// <param name="destinationRowIndex" >Destination row index.</param>
			 virtual void 		CopyIRow(intrusive_ptr<Aspose::Cells::ICells> sourceCells , Aspose::Cells::System::Int32 sourceRowIndex , Aspose::Cells::System::Int32 destinationRowIndex)=0;
			/// <summary>
			...
			/// <param name="rowNumber" >The copied row number.</param>
			 virtual void 		CopyIRows(intrusive_ptr<Aspose::Cells::ICells> sourceCells , Aspose::Cells::System::Int32 sourceRowIndex , Aspose::Cells::System::Int32 destinationRowIndex , Aspose::Cells::System::Int32 rowNumber)=0;
			/// <summary>
			/// Copies data and formatting of some whole rows.
			/// </summary>
			/// <param name="sourceCells" >Source Cells object contains data and formatting to copy.</param>
			...
			/// <param name="copyOptions" >The copy options.</param>
			 virtual void 		CopyIRows(intrusive_ptr<Aspose::Cells::ICells> sourceCells , Aspose::Cells::System::Int32 sourceRowIndex , Aspose::Cells::System::Int32 destinationRowIndex , Aspose::Cells::System::Int32 rowNumber , intrusive_ptr<Aspose::Cells::ICopyOptions> copyOptions)=0;
			/// <summary>
			...
			/// <param name="destColumn" >The dest column.</param>
			 virtual void 		MoveIRange(intrusive_ptr<Aspose::Cells::ICellArea> sourceArea , Aspose::Cells::System::Int32 destRow , Aspose::Cells::System::Int32 destColumn)=0;
			/// <summary>
			...
			/// <param name="updateReference" >Indicates if update references in other worksheets.</param>
			 virtual void 		InsertIRange(intrusive_ptr<Aspose::Cells::ICellArea> area , Aspose::Cells::System::Int32 shiftNumber , Aspose::Cells::ShiftType shiftType , bool updateReference)=0;
			/// <summary>
			/// Inserts a range of cells and shift cells according to the shift option.
			/// </summary>
			/// <param name="area" >Shift area.</param>
			...
			/// <param name="shiftNumber" >Number of rows or columns to be inserted.</param>
			/// <param name="shiftType" >Shift cells option.</param>
			 virtual void 		InsertIRange(intrusive_ptr<Aspose::Cells::ICellArea> area , Aspose::Cells::System::Int32 shiftNumber , Aspose::Cells::ShiftType shiftType)=0;
			/// <summary>
