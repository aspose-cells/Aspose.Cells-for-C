...
#define STATIC_FORMULANODEOPERATORNE() 
...
namespace Cells {
namespace FormulaModel {
	class FormulaNodeOperatorNE : public Aspose::Cells::FormulaModel::FormulaNodeOperatorCompare
	{
	protected:
	...
	public:
			 ...
			 FormulaNodeOperatorNE();
		public:
			virtual ~FormulaNodeOperatorNE();
	};
