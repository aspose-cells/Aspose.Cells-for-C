...
#define STATIC_PARALLELALGORITHMSUMX2PY2() 
...
namespace Cells {
namespace FormulaModel {
	class ParallelAlgorithmSUMX2PY2 : public Aspose::Cells::FormulaModel::IParallel1DNumberAlgorithm
	{
	private:
	...
	public:
			...
			intrusive_ptr<Aspose::Cells::FormulaModel::IFormulaNode> GetResultOfEmpty();
			 ParallelAlgorithmSUMX2PY2();
		public:
			virtual ~ParallelAlgorithmSUMX2PY2();
		public:
