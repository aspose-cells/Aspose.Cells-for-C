...
#define STATIC_PARALLELALGORITHMSUMXMY2() 
...
namespace Cells {
namespace FormulaModel {
	class ParallelAlgorithmSUMXMY2 : public Aspose::Cells::FormulaModel::IParallel1DNumberAlgorithm
	{
	private:
	...
	public:
			...
			intrusive_ptr<Aspose::Cells::FormulaModel::IFormulaNode> GetResultOfEmpty();
			 ParallelAlgorithmSUMXMY2();
		public:
			virtual ~ParallelAlgorithmSUMXMY2();
		public:
