...
#define STATIC_COMBINEDALGORITHMFUNCMULTIPLESIMPLE() 
...
namespace Cells {
namespace FormulaModel {
	class CombinedAlgorithmFuncMultipleSimple : public Aspose::Cells::FormulaModel::CombinedAlgorithmFuncMultiple
	{
	private:
	...
	public:
			 ...
			 CombinedAlgorithmFuncMultipleSimple();
		public:
			virtual ~CombinedAlgorithmFuncMultipleSimple();
	};
