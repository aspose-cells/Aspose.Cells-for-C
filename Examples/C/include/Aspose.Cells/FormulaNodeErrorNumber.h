...
#define STATIC_FORMULANODEERRORNUMBER() 
...
namespace Cells {
namespace FormulaModel {
	class FormulaNodeErrorNumber : public Aspose::Cells::FormulaModel::FormulaNodeError
	{
	private:

			void Init_Vars();
			 FormulaNodeErrorNumber();
	public:
		...
		public:
			virtual ~FormulaNodeErrorNumber();
	};
