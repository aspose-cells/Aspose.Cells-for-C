...
#define STATIC_RANGEDATAWRAPPERFILTERSINGLEROW() 
...
namespace Cells {
namespace FormulaModel {
	class RangeDataWrapperFilterSingleRow : public Aspose::Cells::FormulaModel::RangeDataWrapperCombinedSingleBase
	{
	private:
	...
	public:
			 ...
			 RangeDataWrapperFilterSingleRow(intrusive_ptr<Aspose::Cells::FormulaModel::IRangeDataWrapperFormulaNode> wrapper , intrusive_ptr<Aspose::Cells::FormulaModel::FormulaRelInfo> relInfo , Aspose::Cells::System::Int32 row);
			 ...
			 RangeDataWrapperFilterSingleRow();
		public:
			virtual ~RangeDataWrapperFilterSingleRow();
	};
