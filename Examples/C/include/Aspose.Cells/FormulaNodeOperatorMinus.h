...
#define STATIC_FORMULANODEOPERATORMINUS() 
...
namespace Cells {
namespace FormulaModel {
	class FormulaNodeOperatorMinus : public Aspose::Cells::FormulaModel::FormulaNodeOperatorMath
	{
	protected:
	...
	public:
			 ...
			 FormulaNodeOperatorMinus();
		public:
			virtual ~FormulaNodeOperatorMinus();
	};
