...
#define STATIC_FORMULANODEOPERATORINTERSECT() 
...
namespace Cells {
namespace FormulaModel {
	class FormulaNodeOperatorIntersect : public Aspose::Cells::FormulaModel::FormulaNodeOperatorReference
	{
	protected:
	...
	public:
			 ...
			 FormulaNodeOperatorIntersect();
		public:
			virtual ~FormulaNodeOperatorIntersect();
	};
