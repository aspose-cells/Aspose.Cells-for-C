...
#define STATIC_STATISTICSALGORITHMLCM() 
...
namespace Cells {
namespace FormulaModel {
	class StatisticsAlgorithmLCM : public Aspose::Cells::FormulaModel::StatisticsAlgorithmMath
	{
	protected:
