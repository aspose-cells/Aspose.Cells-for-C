...
#define STATIC_XLSXBIN2RCSTRING() 
...
namespace Formula2007 {
	class XlsxBin2RCString : public Aspose::Cells::System::Object
	{
	private:
			...
			intrusive_ptr<Aspose::Cells::System::String> GetSheetName(intrusive_ptr<Aspose::Cells::System::Array1D<Aspose::Cells::System::Byte>> data , Aspose::Cells::System::Int32 pos);
	...
	public:
			 ...
			 XlsxBin2RCString(intrusive_ptr<Aspose::Cells::WorksheetCollection> sheets);
