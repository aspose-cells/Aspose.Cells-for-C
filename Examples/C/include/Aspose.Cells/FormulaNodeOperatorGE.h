...
#define STATIC_FORMULANODEOPERATORGE() 
...
namespace Cells {
namespace FormulaModel {
	class FormulaNodeOperatorGE : public Aspose::Cells::FormulaModel::FormulaNodeOperatorCompare
	{
	private:
	...
	public:
			 ...
			 FormulaNodeOperatorGE();
		public:
			virtual ~FormulaNodeOperatorGE();
	};
