...
#define STATIC_RANGEDATAWRAPPERNA1DDEFAULTNA() 
...
namespace Cells {
namespace FormulaModel {
	class RangeDataWrapperNA1DDefaultNA : public Aspose::Cells::FormulaModel::RangeDataWrapperNA1DBase
	{
	private:
	...
	public:
			 ...
			 RangeDataWrapperNA1DDefaultNA(intrusive_ptr<Aspose::Cells::FormulaModel::IRangeDataWrapperFormulaNode> wrapper , Aspose::Cells::System::Int32 totalCount);
			 ...
			 RangeDataWrapperNA1DDefaultNA();
		public:
			virtual ~RangeDataWrapperNA1DDefaultNA();
	};
