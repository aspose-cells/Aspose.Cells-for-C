...
#define STATIC_VALIDATIONFORMULA2007() 
...
namespace Validation2007 {
	class ValidationFormula2007 : public Aspose::Cells::System::Object
	{
	private:
	...
	public:
			 ...
			 ValidationFormula2007(intrusive_ptr<Aspose::Cells::Worksheet> sheet);
			...
			void CreateFormula(intrusive_ptr<Aspose::Cells::Validation> dv);
			 ValidationFormula2007();
		public:
			virtual ~ValidationFormula2007();
	};
