...
namespace Internal {
namespace Format {
	class SpecialG : public Aspose::Cells::Internal::Format::AbstractSpecialDateFormatter
	{
	protected:
	...
	public:
			 ...
			 SpecialG(intrusive_ptr<Aspose::Cells::Internal::Format::CellsFormatterParams> formatterParam , intrusive_ptr<Aspose::Cells::System::String> pattern , intrusive_ptr<Aspose::Cells::System::String> header , intrusive_ptr<Aspose::Cells::System::String> tail);
			 SpecialG();
		public:
			virtual ~SpecialG();
	};
