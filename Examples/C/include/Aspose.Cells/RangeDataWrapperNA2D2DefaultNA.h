...
#define STATIC_RANGEDATAWRAPPERNA2D2DEFAULTNA() 
...
namespace Cells {
namespace FormulaModel {
	class RangeDataWrapperNA2D2DefaultNA : public Aspose::Cells::FormulaModel::RangeDataWrapperNA2D2Base
	{
	private:
	...
	public:
			 ...
			 RangeDataWrapperNA2D2DefaultNA(intrusive_ptr<Aspose::Cells::FormulaModel::IRangeDataWrapperFormulaNode> wrapper , Aspose::Cells::System::Int32 rowCount , Aspose::Cells::System::Int32 colCount);
			 ...
			 RangeDataWrapperNA2D2DefaultNA();
		public:
			virtual ~RangeDataWrapperNA2D2DefaultNA();
	};
