...
namespace FormulaModel {
	...
	private:
			...
			intrusive_ptr<Aspose::Cells::FormulaModel::ICombinedAlgorithm> _algorithmCopy;
			intrusive_ptr<Aspose::Cells::FormulaModel::IRangeDataWrapperFormulaNode> _cacheCopy;
