...
#define STATIC_STATISTICSALGORITHMMULTINOMIAL() 
...
namespace Cells {
namespace FormulaModel {
	class StatisticsAlgorithmMULTINOMIAL : public Aspose::Cells::FormulaModel::StatisticsAlgorithmMath
	{
	protected:
