...
#define STATIC_FORMULANODEOPERATORLE() 
...
namespace Cells {
namespace FormulaModel {
	class FormulaNodeOperatorLE : public Aspose::Cells::FormulaModel::FormulaNodeOperatorCompare
	{
	private:
	...
	public:
			 ...
			 FormulaNodeOperatorLE();
		public:
			virtual ~FormulaNodeOperatorLE();
	};
