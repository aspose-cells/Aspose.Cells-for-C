...
#define STATIC_STATISTICSALGORITHMMAX() 
...
namespace Cells {
namespace FormulaModel {
	class StatisticsAlgorithmMax : public Aspose::Cells::FormulaModel::StatisticsAlgorithmMath
	{
	protected:
	...
	public:
			 ...
			 StatisticsAlgorithmMax(bool isA , bool ignoreError);
			 virtual void Reset();
			 virtual intrusive_ptr<Aspose::Cells::FormulaModel::IFormulaNode> GetResult();
			 StatisticsAlgorithmMax();
		public:
			virtual ~StatisticsAlgorithmMax();
	};
