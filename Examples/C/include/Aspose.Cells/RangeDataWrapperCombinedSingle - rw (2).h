...
#include "RangeDataWrapperCombinedWithCache.h"///
...
namespace FormulaModel {
	...
	private:
			...
			void Init_Vars();
			intrusive_ptr<Aspose::Cells::FormulaModel::ICombinedAlgorithmSingle> _algorithm;
			...
			intrusive_ptr<Aspose::Cells::FormulaModel::ICombinedAlgorithm> mAlgoSingle;///

			intrusive_ptr<Aspose::Cells::FormulaModel::IRangeDataWrapperFormulaNode> _getcopy;///
			intrusive_ptr<Aspose::Cells::FormulaModel::RangeDataWrapperCombinedWithCache> _getcopyCache;///
			intrusive_ptr<Aspose::Cells::FormulaModel::ICombinedAlgorithmSingle> pAalgorithm;///
