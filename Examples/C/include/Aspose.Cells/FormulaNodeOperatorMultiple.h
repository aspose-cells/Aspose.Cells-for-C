...
#define STATIC_FORMULANODEOPERATORMULTIPLE() 
...
namespace Cells {
namespace FormulaModel {
	class FormulaNodeOperatorMultiple : public Aspose::Cells::FormulaModel::FormulaNodeOperatorMath
	{
	protected:
	...
	public:
			 ...
			 FormulaNodeOperatorMultiple();
		public:
			virtual ~FormulaNodeOperatorMultiple();
	};
