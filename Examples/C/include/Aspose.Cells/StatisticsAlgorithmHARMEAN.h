...
#define STATIC_STATISTICSALGORITHMHARMEAN() 
...
namespace Cells {
namespace FormulaModel {
	class StatisticsAlgorithmHARMEAN : public Aspose::Cells::FormulaModel::StatisticsAlgorithmMath
	{
	protected:
