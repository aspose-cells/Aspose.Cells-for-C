...
#define STATIC_FORMULATOKENVISITOR2003() 
...
namespace Cells {
namespace FormulaModel {
	class FormulaTokenVisitor2003 : public Aspose::Cells::FormulaModel::FormulaTokenVisitor
	{
	private:

			void Init_Vars();
			void SkipArrayData();
			intrusive_ptr<Aspose::Cells::System::String> ReadArrayString();
	protected:
	...
	public:
			 ...
			 FormulaTokenVisitor2003();
		public:
			virtual ~FormulaTokenVisitor2003();
	};
