...
#define STATIC_RANGEDATAWRAPPERNA2DHDEFAULTNA() 
...
namespace Cells {
namespace FormulaModel {
	class RangeDataWrapperNA2DHDefaultNA : public Aspose::Cells::FormulaModel::RangeDataWrapperNA2DHBase
	{
	private:
	...
	public:
			 ...
			 RangeDataWrapperNA2DHDefaultNA(intrusive_ptr<Aspose::Cells::FormulaModel::IRangeDataWrapperFormulaNode> wrapper , Aspose::Cells::System::Int32 totalCount);
			 ...
			 RangeDataWrapperNA2DHDefaultNA();
		public:
			virtual ~RangeDataWrapperNA2DHDefaultNA();
	};
