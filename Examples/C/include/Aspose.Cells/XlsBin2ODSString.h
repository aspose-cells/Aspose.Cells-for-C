...
#define STATIC_XLSBIN2ODSSTRING() 
...
namespace Formula2003 {
	class XlsBin2ODSString : public Aspose::Cells::System::Object
	{
	private:
	...
	public:
			...
			bool SquareBrackets;
			 XlsBin2ODSString(intrusive_ptr<Aspose::Cells::WorksheetCollection> sheets);
