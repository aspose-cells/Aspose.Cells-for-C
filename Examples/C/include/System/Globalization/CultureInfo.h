	...
	namespace Cells { 
		namespace System {
			namespace Globalization {
				...
				{
				private:
					static intrusive_ptr<CultureInfo> INVARIANT_CULTURE;// = NEW CultureInfo(Locale->US, true);
					static intrusive_ptr<CultureInfo> DEFAULT_CULTURE;// = NEW CultureInfo(Locale->getDefault());
