...
namespace Drawing2D {
	...
	public:
		...
		public:
			...
			PathGradientBrush(Array1D<Point*>* points);
			PathGradientBrush(Array1D<PointF*>* points);
			PathGradientBrush(Array1D<Point*>* points, WrapMode wrapMode);
			PathGradientBrush(Array1D<PointF*>* points, WrapMode wrapMode);
