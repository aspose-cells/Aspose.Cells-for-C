...
namespace Drawing2D {
	...
	public:
		...
		public:
			...
			GraphicsPath(Array1D<Point*>* pts, Array1D<Byte>* types);
			GraphicsPath(Array1D<PointF*>* pts, Array1D<Byte>* types);
			GraphicsPath(Array1D<Point*>* pts, Array1D<Byte>* types, FillMode fillMode);
			GraphicsPath(Array1D<PointF*>* pts, Array1D<Byte>* types, FillMode fillMode);
