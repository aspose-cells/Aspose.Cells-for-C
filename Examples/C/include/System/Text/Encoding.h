		...
		namespace System {
			namespace Text {
				...
				public:
					...
					static intrusive_ptr<Encoding> GetEncoding(Int32 codepage);//to do
					static intrusive_ptr<Encoding> GetEncoding(StringPtr name);//to do
					static intrusive_ptr<Encoding> GetDefault();//to do
				...
				private:
					...
					//static intrusive_ptr<Encoding> icuEncoding;
