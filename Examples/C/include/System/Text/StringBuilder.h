	...
	namespace Cells {
		namespace System {
			namespace Text {
				...
				{
				private:
					//const StringPtr CapacityField = "Capacity";
					//const StringPtr MaxCapacityField = "m_MaxCapacity";
					//const StringPtr StringValueField = "m_StringValue";
					//const StringPtr ThreadIDField = "m_currentThread";
				...
				protected:
					...
					int m_ChunkOffset;
					int m_MaxCapacity;
					//int m_capacity;//just == m_ChunkChars->length
				...
				public:
					...
					/*
					intrusive_ptr<StringBuilder> AppendFormat(StringPtr format, Object *arg0);
					intrusive_ptr<StringBuilder> AppendFormat(StringPtr format, Object *arg0, Object *arg1);
					intrusive_ptr<StringBuilder> AppendFormat(StringPtr format, Object *arg0, Object *arg1, Object *arg2);
					intrusive_ptr<StringBuilder> AppendFormat(StringPtr format, intrusive_ptr<Array1D<Object*>> args);
					*/
