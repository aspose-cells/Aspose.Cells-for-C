		...
		namespace System {
			namespace Text {
				...
				public:
					...
					//virtual int32_t GetChars(Byte* bytes, int32_t length, int32_t byteCount, Char* chars, int32_t charsLength, int32_t charCount);
					virtual int32_t GetChars(Byte* bytes, int32_t byteCount, Char* chars, int32_t charCount, intrusive_ptr<DecoderNLS> baseDecoder);
					//virtual int32_t GetChars(Byte* bytes, int32_t length, int32_t byteCount, Char* chars, int32_t charsLength, int32_t charCount, intrusive_ptr<DecoderNLS> decoder);
