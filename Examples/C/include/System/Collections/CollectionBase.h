	...
	namespace Cells { 
		namespace System{
			namespace Collections {
				class ArrayList;
				class ASPOSE_CELLS_API CollectionBase : public Object, public IList//, public ICollection, public IEnumerable
				{
				private:
				...
				public :
					...
					ObjectPtr Clone();
					bool ContainsKey(ObjectPtr obj);
					bool ContainsValue(ObjectPtr obj);
					Int32 Count();
					ICollection* GetKeys();
