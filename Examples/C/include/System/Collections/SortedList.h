		...
		namespace System {
			namespace Collections {
				...
				private:
					...
					public:
						...
						virtual void CopyTo(intrusive_ptr<Array> array0, int arrayIndex)//
						{
							...
							//intrusive_ptr<Array1D<Object*>> array00 = dynamic_pointer_cast<Array1D<Object*>>(array0);
							//ArrayHelper::Copy(this->sortedList->keys, 0, array00, arrayIndex, this->sortedList->GetCount());
					...
					public:
						...
						virtual void CopyTo(intrusive_ptr<Array> array0, int arrayIndex)
						{
							...
							//intrusive_ptr<Array1D<Object*>> array00 = dynamic_pointer_cast<Array1D<Object*>>(array0);
							//ArrayHelper::Copy(this->sortedList->values, 0, array00, arrayIndex, this->sortedList->GetCount());
				...
				public:
					...
					virtual IEnumeratorPtr GetEnumerator();//IDictionaryEnumerator*
					virtual void RemoveAt(int index);
					virtual void Remove(ObjectPtr key);
