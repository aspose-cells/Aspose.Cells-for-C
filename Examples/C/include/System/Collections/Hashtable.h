	...
	namespace Cells {
		namespace System {
			namespace Collections {
				class ASPOSE_CELLS_API Hashtable : public Object, public ICloneable, public IEnumerable
				{
				private:
					...
					public:
						...
						virtual void CopyTo(intrusive_ptr<Array> array0, int32_t arrayIndex)
						{
							...
							//intrusive_ptr<Array1D<Object*>> array1 = dynamic_pointer_cast<Array1D<Object*>>(array0);
				...
				private:
					...
					int loadsize;
					float loadFactor;
					int version;//volatile
					bool isWriterInProgress;//volatile
					ICollectionPtr keys;
					ICollectionPtr values;
					IEqualityComparerPtr _keycomparer;
					ObjectPtr _syncRoot;
					static const int InitialSize = 3;
					//const String* LoadFactorName = NEW String("LoadFactor");
					//const String* VersionName = NEW String("Version");
					//const String* ComparerName = NEW String("Comparer");
					//const String* HashCodeProviderName = NEW String("HashCodeProvider");
					//const String* HashSizeName = NEW String("HashSize");
					//const String* KeysName = NEW String("Keys");
					//const String* ValuesName = NEW String("Values");
					//const String* KeyComparerName = NEW String("KeyComparer");
				private:
				...
				public:
					...
					virtual IEnumeratorPtr GetEnumerator();		// require HashtableEnumerator*
					...
					virtual intrusive_ptr<Array1D<KeyValuePairs*>> ToKeyValuePairsArray();		// memory leak! ??
